...
UPLOAD_DIR = os.path.join(TEMP_DIR, "swipecut", "original")
SEGMENTS_DIR = os.path.join(TEMP_DIR, "swipecut", "segments")
EXPORT_DIR = os.path.join(TEMP_DIR, "swipecut", "export")
